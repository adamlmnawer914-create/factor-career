...
window.CareerAI.i18n = {
  ...
  translations: {
    ar: {
      ...
      // Hero Section
      'hero.badge': 'منصة السيرة الذاتية والبحث عن وظائف بالذكاء الاصطناعي',
      'hero.title1': 'صانع السيرة الذاتية الاحترافية',
      'hero.title2': 'والبحث عن أفضل الوظائف',
      'hero.title3': 'بتقنيات الذكاء الاصطناعي المجانية',
      'hero.subtitle': 'صمم سيرة ذاتية احترافية مجاناً بالذكاء الاصطناعي، اجتز أنظمة الفرز ATS، واستكشف أحدث الوظائف وفرص العمل بسهولة مع Factor Career.',
      'hero.btnBuild': 'أنشئ سيرتك الذاتية الآن',
      'hero.btnExplore': 'استكشف جميع الوظائف والأدوات',
      'hero.stat1Num': '100%',
    ...
    en: {
      ...
      // Hero Section
      'hero.badge': 'AI Resume Builder & Job Search Platform',
      'hero.title1': 'Free AI Resume Builder',
      'hero.title2': '& Curated Career Opportunities',
      'hero.title3': 'Land Your Dream Job Faster',
      'hero.subtitle': 'Build an ATS-optimized professional resume for free with AI and discover active job openings easily with Factor Career.',
      'hero.btnBuild': 'Build Your Resume Now',
      'hero.btnExplore': 'Explore All Jobs & Tools',
      'hero.stat1Num': '100%',
